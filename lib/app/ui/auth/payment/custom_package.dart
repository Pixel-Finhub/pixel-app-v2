                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: fluidHeight(context, 5)), // Increase spacing
                      const Divider(
                        color: Colors.white,
                      ...
                      Text(
                        "Pixel Insurance's Custom Package is a package that allows you to choose the amount of money you want to insure. The charges are 1% of the amount you want to insure. and the rest come from risk assessment of the transported goods",
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: fluidFontSize(
